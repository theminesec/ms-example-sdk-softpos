...
import com.theminesec.example.sdk.softpos.util.crypto.PinBlock
import com.theminesec.example.sdk.softpos.util.crypto.PinBlock.PinBlockFormat.*
...
class PinBlockUnitTest {
    ...
    fun `test pin to pinblock iso0`() {
        ...
        val pinBlock = PinBlock.getPinBlock(pin, Iso0, pan)
    ...
    fun `test pin to pinblock iso1`() {
        ...
        val pinBlock = PinBlock.getPinBlock(pin, Iso1)
    ...
    fun `test pin to pinblock iso2`() {
        ...
        val pinBlock = PinBlock.getPinBlock(pin, Iso2)
        assertEquals(expected.lowercase(), pinBlock.lowercase())
    }
    ...
    fun `test pin to pinblock iso3`() {
        ...
        val pinBlock = PinBlock.getPinBlock(pin, PinBlock.PinBlockFormat.Iso3, pan)
    ...
    fun `test format4 epb to plain pin`() {
        ...
        val epb = PinBlock.getPinBlock(pin, Iso4, pan, pinKey)
        println("iso4 epb: $epb")
        val calculated = PinBlock.dangerouslyDecryptIso4EpbToPin(pinKey, epb.hexToByteArray(), pan)
